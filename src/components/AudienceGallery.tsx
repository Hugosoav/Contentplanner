...
const ImageCard = ({ src, onLoad }: ImageCardProps) => {
  return (
    <div className="w-full h-[200px] sm:h-[300px] md:h-[400px] flex-shrink-0 bg-[#111] transition-transform duration-300 hover:scale-[1.02] cursor-pointer relative will-change-transform">
      <img
        src={src}
        alt="Gallery Asset"
        loading="lazy"
...
export default function AudienceGallery() {
  ...
  const handleItemLoad = useCallback(() => {
    ...
    setIsReady((r) => r || loadedCountRef.current >= 1);
  }, []);
  ...
  return (
    <div
      ...
      className="w-full h-screen overflow-y-auto overflow-x-hidden bg-[#050505] rounded-3xl border border-white/10"
    >
      <section
        ref={containerRef}
      ...
      >
        <div className="sticky top-0 h-screen w-full flex justify-center items-center overflow-hidden">
          <motion.div
            ...
            className="relative bg-black overflow-hidden flex items-center justify-center max-w-[1920px] mx-auto will-change-transform"
          >
            <div
            ...
            >
              ...
              <motion.div
                ...
                className="flex gap-4 md:gap-6 justify-center items-center w-[120vw] h-[150vh] origin-center opacity-100 will-change-transform"
              >
